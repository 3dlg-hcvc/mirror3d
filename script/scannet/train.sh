...
--refined_depth \
--coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/scannet/with_mirror/precise/network_input_json/train_10_normal_all.json \
--coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/scannet/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
--coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/scannet \
--coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/scannet \
--coco_focal_len 575 \
--depth_shift 1000 \
--input_height 480 \
--input_width 640 \
