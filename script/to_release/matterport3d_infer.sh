...
# --resume_checkpoint_path /local-scratch/jiaqit/exp/Mirror3D/checkpoint/m3d/finetune_dg/saic_rawD.pth \
...
# python init_depth_generator/saic_depth_completion/init_depth_gen_infer.py \
# --refined_depth \
# --resume_checkpoint_path /local-scratch/jiaqit/exp/Mirror3D/checkpoint/m3d/finetune_dg/snapshot_mse_0.0420.pth \
# --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/train_10_normal_all.json \
# --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
# --coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d \
# --coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d \
...
# --resume_checkpoint_path /local-scratch/jiaqit/exp/Mirror3D/checkpoint/m3d/finetune_dg/bts_rawD \
# --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/train_10_normal_all.json \
# --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
# --coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d \
# --coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d \
...
# python init_depth_generator/bts/pytorch/init_depth_gen_infer.py \
# --refined_depth \
# --resume_checkpoint_path /local-scratch/jiaqit/exp/Mirror3D/checkpoint/m3d/finetune_dg/bts_refD \
# --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/train_10_normal_all.json \
# --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
# --coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d \
# --coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d \
...
# --resume_checkpoint_path /local-scratch/jiaqit/exp/Mirror3D/checkpoint/m3d/finetune_dg/vnl_rawD.pth \
# --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/train_10_normal_all.json \
# --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
# --coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d \
# --coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d \
...
# python init_depth_generator/VNL_Monocular_Depth_Prediction/init_depth_gen_infer.py \
# --refined_depth \
# --resume_checkpoint_path /local-scratch/jiaqit/exp/Mirror3D/checkpoint/m3d/finetune_dg/vnl_refD.pth \
# --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/train_10_normal_all.json \
# --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
# --coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d \
# --coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d \
...
to_ref_txt_list="waste/0420_torefine.txt"
...
# echo "PlaneRCNN rawD infadv_nerence"
# python mirror3dnet/run_mirror3dnet.py \
# --eval \
# --mesh_depth \
# --eval_save_depth \
# --resume_checkpoint_path /local-scratch/jiaqit/exp/Mirror3D/checkpoint/m3d/planercnn_rawD.pth \
...
# --mesh_depth \
# --eval_save_depth \
# --resume_checkpoint_path /local-scratch/jiaqit/exp/Mirror3D/checkpoint/m3d/planercnn_refD.pth \
# --config mirror3dnet/config/planercnn_config.yml \
# --refined_depth \
# --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/train_10_normal_mirror.json \
# --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
...
# --mesh_depth \
# --eval_save_depth \
# --resume_checkpoint_path /local-scratch/jiaqit/exp/Mirror3D/checkpoint/m3d/m3d_rawD.pth \
...
# --mesh_depth \
# --eval_save_depth \
# --resume_checkpoint_path /local-scratch/jiaqit/exp/Mirror3D/checkpoint/m3d/m3d_refD.pth \
# --config mirror3dnet/config/mirror3dnet_config.yml \
# --refined_depth \
# --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/train_10_normal_mirror.json \
# --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/m3d/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
