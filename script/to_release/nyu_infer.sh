...
# --input_height 480 \
# --input_width 640 \
# --output_save_folder debug/nyu_infer

# # # bts test on rawD checkpoint
# # python init_depth_generator/bts/pytorch/init_depth_gen_infer.py \
# # --resume_checkpoint_path /project/3dlg-hcvc/jiaqit/debug_0331/checkpoint/nyu/bts_rawD \
# # --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/train_10_normal_all.json \
# # --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
# # --coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
# # --coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
...
# python init_depth_generator/bts/pytorch/init_depth_gen_infer.py \
# --refined_depth \
# --resume_checkpoint_path /project/3dlg-hcvc/jiaqit/debug_0331/checkpoint/nyu/bts_refD \
# --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/train_10_normal_all.json \
# --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
# --coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
# --coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
...
# # python init_depth_generator/VNL_Monocular_Depth_Prediction/init_depth_gen_infer.py \
# # --resume_checkpoint_path /project/3dlg-hcvc/jiaqit/debug_0331/checkpoint/nyu/vnl_rawD.pth \
# # --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/train_10_normal_all.json \
# # --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
# # --coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
# # --coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
...
# python init_depth_generator/VNL_Monocular_Depth_Prediction/init_depth_gen_infer.py \
# --refined_depth \
# --resume_checkpoint_path /project/3dlg-hcvc/jiaqit/debug_0331/checkpoint/nyu/vnl_refD.pth \
# --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/train_10_normal_all.json \
# --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
# --coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
# --coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
...
# --resume_checkpoint_path /project/3dlg-hcvc/jiaqit/debug_0331/checkpoint/nyu/saic_rawD.pth \
# --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/train_10_normal_all.json \
# --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
# --coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
# --coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
...
# python init_depth_generator/saic_depth_completion/init_depth_gen_infer.py \
# --refined_depth \
# --resume_checkpoint_path /project/3dlg-hcvc/jiaqit/debug_0331/checkpoint/nyu/saic_refD.pth \
# --coco_train /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/train_10_normal_all.json \
# --coco_val /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise/network_input_json/test_10_normal_mirror.json \
# --coco_train_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
# --coco_val_root /project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu \
...
#     --eval \
#     --resume_checkpoint_path /project/3dlg-hcvc/jiaqit/debug_0331/checkpoint/nyu/m3n_noraml_10.pth \
