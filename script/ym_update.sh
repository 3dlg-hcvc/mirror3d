...
--stage 3 \
--data_main_folder /project/3dlg-hcvc/mirrors/www/final_anno/m3d_yiming_change_f \
--anno_output_folder /project/3dlg-hcvc/mirrors/www/final_anno/m3d_yiming_change_f \
...
--stage all \
--data_main_folder /project/3dlg-hcvc/mirrors/www/final_anno/m3d_yiming_change_f \
--output_folder /project/3dlg-hcvc/mirrors/www/final_anno/m3d_yiming_change_f \
--f 1076 --multi_processing --overwrite --process_index {1} >& ${log_folder}/ym_update.log" ::: {0..160}