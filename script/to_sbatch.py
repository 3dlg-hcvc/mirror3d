...
def sh_to_sbatch_train(train_sh_path, log_config, sh_output_foler, sbatch_config, env_config, run_time):
    """
    Args:
...
def sh_to_sbatch_test(train_sh_path, log_config, sh_output_foler, sbatch_config, env_config, run_time):
    """
    Args:
        train_sh_path : the .sh file
        log_config : folder to store the sbatch .sh file
...
if __name__ == "__main__":
    ...
    for run_index in range(int(args.run_time)):
        if args.mode == "train":
            sh_to_sbatch_train(args.train_sh_path, args.log_config, args.sh_output_foler, sbatch_config, env_config, run_index) 
        else:
            sh_to_sbatch_test(args.train_sh_path, args.log_config, args.sh_output_foler, sbatch_config, env_config, run_index) 
