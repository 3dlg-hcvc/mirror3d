...
class Dataset_visulization(Dataset_visulization):
    ...
    def __init__(self, pred_w=480, pred_h=640, dataset_main_folder=None, test_json="", method_tag="mirror3D",
                 process_index=0, multi_processing=False, f=519, output_folder=None, overwrite=True, window_w=800,
                 window_h=800, view_mode="topdown"):
        """
        Initialization

        Args:
            dataset_main_folder : Folder raw, hole_raw_depth/ mesh_raw_depth, instance_mask saved folder.
            output_folder(optional) : Inital pcd, img_info, border_vis saved folder (default : dataset_main_folder).
    ...
    def generate_pcd_for_one_prediction(self, color_img_path):
        ...
        def save_topdown(pcd, topdown_img_save_path):
            ...
            stage_translation = get_extrinsic(0, 0, 0, [-mesh_center[0], -mesh_center[1] + min_h * 3, -mesh_center[2]])
    ...
    def generate_html(self, vis_saved_main_folder="", sample_num_per_page=50, template_path=""):
        ...
        for html_index, one_colorSubset in enumerate(color_img_subset_list):
            ...
            print("result visualisation saved in link {}".format(
                html_path.replace("/project/3dlg-hcvc/mirrors/www", "https://aspis.cmpt.sfu.ca/projects/mirrors")))


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Get Setting :D')
    parser.add_argument('--stage', default="6")
    parser.add_argument('--test_json', default="/project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu/with_mirror/precise"
                                               "/network_input_json/test_10_normal_mirror.json")
    parser.add_argument('--method_predFolder_txt', default="/project/3dlg-hcvc/mirrors/www/notes/nyu_vis_0418.txt")
    parser.add_argument('--dataset_main_folder', default="/project/3dlg-hcvc/mirrors/www/Mirror3D_final/nyu")
    parser.add_argument('--process_index', default=0, type=int, help="process index")
    ...
    parser.add_argument('--f', default=537, type=int, help="camera focal length")
    parser.add_argument('--pred_w', default=640, type=int, help="width of the visualization window")
    parser.add_argument('--pred_h', default=512, type=int, help="width of the visualization window")
    parser.add_argument('--window_w', default=800, type=int, help="width of the visualization window")
    parser.add_argument('--window_h', default=800, type=int, help="height of the visualization window")
    parser.add_argument('--sample_num_per_page', default=100, type=int, help="height of the visualization window")
    parser.add_argument('--vis_saved_folder', default="/project/3dlg-hcvc/mirrors/www/cr_vis/nyu_result_vis")
    parser.add_argument('--output_folder', default="/project/3dlg-hcvc/mirrors/www/cr_vis/nyu_html")
    parser.add_argument('--method_folder_list', nargs='+', default="", type=str)
    parser.add_argument("--midrule_index", nargs="+", type=int, default=[2, 5],
                        help="add /midrule in after these liens; index start from 1")
    parser.add_argument('--template_path', default="visualization/template/result_vis_template.html", type=str)
    parser.add_argument('--view_mode', default="topdown", help="object view angle : (1) topdown (2) front")
    parser.add_argument('--method_order_txt', default="", type=str)
    parser.add_argument('--dataset_tag', default="NYUv2", type=str)
    parser.add_argument('--all_info_json', default="output/ref_m3d_result.json", type=str)
    ...
    vis_tool = Dataset_visulization(pred_w=args.pred_w, pred_h=args.pred_h,
