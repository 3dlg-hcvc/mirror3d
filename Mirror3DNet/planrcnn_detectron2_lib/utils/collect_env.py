...
def collect_env_info():
    ...
    try:
        ...
        data.append(
            ("detectron2", planrcnn_detectron2_lib.__version__ + " @" + os.path.dirname(planrcnn_detectron2_lib.__file__))
        )
    except ImportError:
    ...
    try:
        ...
        data.append(("planrcnn_detectron2_lib._C", "failed to import"))
