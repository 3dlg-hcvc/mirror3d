...
from planrcnn_detectron2_lib.modeling import poolers
from planrcnn_detectron2_lib.modeling.proposal_generator import rpn
from planrcnn_detectron2_lib.modeling.roi_heads.mask_head import mask_rcnn_inference
from planrcnn_detectron2_lib.structures import Boxes, ImageList, Instances, Keypoints
...
class Caffe2Boxes(Boxes):
    """
    Representing a list of planrcnn_detectron2_lib.structures.Boxes from minibatch, each box
