...
_C.VERSION = 2
_C.ANCHOR_NORMAL_CLASS_NUM = 8 # changed !!! chris : the number of classes for anchor normal after K-means
...
##################### christina evaluation #####################



_C.TRAIN_COCO_JSON = ("/project/3dlg-hcvc/jiaqit/real_scene_mirror/matterport_0913/summary/640_480_info/pos_train_normalFormat_3_normal.json",) # TODO
_C.VAL_COCO_JSON = ("/project/3dlg-hcvc/jiaqit/real_scene_mirror/matterport_0913/summary/640_480_info/pos_val_normalFormat_3_normal.json",) # TODO
_C.TRAIN_IMG_ROOT = ("/project/3dlg-hcvc/jiaqit/real_scene_mirror/matterport_0913",) # TODO
_C.VAL_IMG_ROOT = ("/project/3dlg-hcvc/jiaqit/real_scene_mirror/matterport_0913",) # TODO
_C.TRAIN_NAME = ("m3d_train",)
_C.VAL_NAME = ("m3d_val",)
...
# IN_FEATURES.
_C.MODEL.ANCHOR_GENERATOR.SIZES =  [[128, 192, 256, 384,512]] # [[32, 64, 128, 256, 512]]
...
_C.TEST.DETECTIONS_PER_IMAGE = 100 # TODO

_C.TEST.AUG = CN({"ENABLED": False})
_C.TEST.AUG.MIN_SIZES = (400, 500, 600, 700, 800, 900, 1000, 1100, 1200)
_C.TEST.AUG.MAX_SIZE = 4000
_C.TEST.AUG.FLIP = False
...
# and access it with:
#
# from planrcnn_detectron2_lib.config import global_cfg
