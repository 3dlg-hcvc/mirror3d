...
from planercnn_COCO import planercnn_COCO
from pycocotools.cocoeval import COCOeval
from planercnn_coco_eval import PlanercnnCOCOeval
from tabulate import tabulate

import planrcnn_detectron2_lib.utils.comm as comm
from planrcnn_detectron2_lib.data import MetadataCatalog
from planrcnn_detectron2_lib.data.datasets.coco import convert_to_coco_json
from planrcnn_detectron2_lib.structures import Boxes, BoxMode, pairwise_iou
from planrcnn_detectron2_lib.utils.logger import create_small_table
...
class COCOEvaluator(DatasetEvaluator):
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir=None):
        ...
        with contextlib.redirect_stdout(io.StringIO()):
            self._coco_api = planercnn_COCO(json_file)
...
def instances_to_coco_json(instances, img_id):
    ...
    # DEPTH_ESTs = instances.DEPTH_ESTs.tolist()
...
def _evaluate_predictions_on_coco(coco_gt, coco_results, iou_type, kpt_oks_sigmas=None, cfg=None):
    ...
    coco_eval = PlanercnnCOCOeval(coco_gt, coco_dt, iou_type, cfg)
    ...
    # if cfg.EVAL_BRANCH_ORI_DEPTH:
    #     print("#################################### {:20} ####################################".format("eval DEPTH_EST branch"))
    #     pass

    # if cfg.EVAL_INPUT_REF_DEPTH:
    #     print("#################################### {:20} ####################################".format("eval depth after refinement"))
    #     pass
