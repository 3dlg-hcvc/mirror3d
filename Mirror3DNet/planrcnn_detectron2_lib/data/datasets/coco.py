...
from planrcnn_detectron2_lib.structures import BoxMode, PolygonMasks, Boxes
...
def convert_to_coco_dict(dataset_name):
    ...
    https://planrcnn_detectron2_lib.readthedocs.io/tutorials/datasets.html#register-a-dataset
    ...
    info = {
        ...
        "description": "Automatically generated COCO json file for planrcnn_detectron2_lib.",
    }
    coco_dict = {
        "info": info,
        "images": coco_images,
...
if __name__ == "__main__":
    ...
    Usage:
        python -m planrcnn_detectron2_lib.data.datasets.coco \
    ...
    import planrcnn_detectron2_lib.data.datasets  # noqa # add pre-defined metadata
    import sys
