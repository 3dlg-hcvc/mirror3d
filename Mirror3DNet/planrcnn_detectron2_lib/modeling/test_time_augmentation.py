...
from planrcnn_detectron2_lib.data.detection_utils import read_image
from planrcnn_detectron2_lib.data.transforms import (
    RandomFlip,
    ResizeShortestEdge,
    ResizeTransform,
    apply_transform_gens,
)
from planrcnn_detectron2_lib.structures import Boxes, Instances
...
class DatasetMapperTTA:
    ...
    def __call__(self, dataset_dict):
        ...
        for min_size in self.min_sizes:
            ...
            # self.flip =  # chris : changed
            # if self.flip:
            #     flip = RandomFlip(prob=1.0)
            #     tfm_gen_candidates.append([flip])  # resize + flip
...
class GeneralizedRCNNWithTTA(nn.Module):
    ...
    def _get_augmented_boxes(self, augmented_inputs, tfms):
        ...
        all_scores = []
        all_classes = []
        for output, tfm in zip(outputs[0], tfms):
