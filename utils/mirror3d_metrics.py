...
class Mirror3dEval:
    def __init__(self, train_with_refD, logger=None, Input_tag="Input_tag", method_tag="method_tag", width=640,
                 height=480, dataset="nyu"):
    ...
    def reset_setting(self, train_with_refD, logger=None, Input_tag="Input_tag", method_tag="method_tag", width=640,
                      height=480):
        self.m_nm_all_refD = torch.zeros(27)
        self.m_nm_all_rawD = torch.zeros(27)
        self.raw_cnt = 0
    ...
    def save_as_table_format(self, eval_measures_cpu, compare_with_raw=False, compute_std=False):
        ...
        table_one_line_result[
            ...
            eval_measures_cpu[18], eval_measures_cpu[3], eval_measures_cpu[12], eval_measures_cpu[21]
        )
        table_one_line_result[
    ...
    def save_result(self, main_output_folder, pred_depth, depth_shift, color_img_path):
        ...
        if "scannet" not in color_img_path:
            ...
            depth_np_save_path = os.path.join(predD_save_folder, "{}_{}".format(refD_gt_depth_path.split("/")[-2],
                                                                                refD_gt_depth_path.split("/")[-1]))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--info_list', default="/project/3dlg-hcvc/jiaqit/cvpr/R1_rerun/to_eval.txt", type=str,
        help="information txt contains color_mask_gtD_predD.txt")
    parser.add_argument(
        '--line', default=0, type=int, help="line to processes from info_list")
    parser.add_argument(
    ...
    logging.basicConfig(filename=log_file_save_path, filemode="a",
    ...
    eval_fun = Mirror3dEval(train_with_refD, logger=logging, Input_tag=Input_tag, method_tag=method_tag, width=640,
                            height=480)
