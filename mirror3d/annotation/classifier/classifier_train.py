...
parser.add_argument('--checkpoint_save_freq', type=int,
                    help="classifier's save frequency (measure in EPOCH), usually set as 10", default=1)
...
parser.add_argument('--train_pos_list', default="", type=str)
parser.add_argument('--train_neg_list', default="", type=str)
parser.add_argument('--val_pos_list', default="", type=str)
parser.add_argument('--val_neg_list', default="", type=str)
