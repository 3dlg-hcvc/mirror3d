...
if __name__ == "__main__":
    ...
    parser.add_argument('--refined_depth',             type=bool, default=True,  help='using coco input format or not')
    ...
    parser.add_argument('--resume_checkpoint_path',           type=str,   help='path to a checkpoint to load', default='checkpoint/m3d_pretrained_m3n.pth')
